...
// const _ = require("loadash");     // Not Working because module not installed, dont know why.
...
app.post("/compose",function(req,res){
  // let userInput = req.body.postTitle;
...
app.get("/posts/:titleName",function(req,res){
  ...
  const requestedTitle = req.params.titleName;
